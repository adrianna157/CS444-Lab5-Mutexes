...
main(int argc, char *argv[])
{
   ...
   6:	83 ec 10             	sub    $0x10,%esp
    ...
    printf(1, "%d %s\n", __LINE__, __FILE__);
   9:	c7 44 24 0c 49 0a 00 	movl   $0xa49,0xc(%esp)
  10:	00 
  11:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
  18:	00 
  19:	c7 44 24 04 52 0a 00 	movl   $0xa52,0x4(%esp)
  20:	00 
  21:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  28:	e8 13 04 00 00       	call   440 <printf>
    if (argc > 1) {
  2d:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  31:	7e 1f                	jle    52 <main+0x52>
        kdebug_value = atoi(argv[1]);
  33:	8b 45 0c             	mov    0xc(%ebp),%eax
  36:	8b 40 04             	mov    0x4(%eax),%eax
  39:	89 04 24             	mov    %eax,(%esp)
  3c:	e8 ef 01 00 00       	call   230 <atoi>
        if (kdebug_value < 0) {
  41:	85 c0                	test   %eax,%eax
  43:	78 11                	js     56 <main+0x56>
  ...
  48:	e8 fd 02 00 00       	call   34a <kdebug>
#endif // KDEBUG
    exit();
  4d:	e8 40 02 00 00       	call   292 <exit>
    int kdebug_value = 0;
  52:	31 c0                	xor    %eax,%eax
  54:	eb ef                	jmp    45 <main+0x45>
            printf(1, "debug value must be >= 0\n");
  56:	c7 44 24 04 59 0a 00 	movl   $0xa59,0x4(%esp)
  5d:	00 
  5e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  65:	e8 d6 03 00 00       	call   440 <printf>
            exit();
  6a:	e8 23 02 00 00       	call   292 <exit>
  6f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d9:	0f b6 92 7a 0a 00 00 	movzbl 0xa7a(%edx),%edx
  }while((x /= base) != 0);
 ...
 44e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5bf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5c1:	b8 73 0a 00 00       	mov    $0xa73,%eax
...
free(void *ap)
{
 ...
 661:	a1 00 0f 00 00       	mov    0xf00,%eax
{
 ...
 6a7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6a9:	a3 00 0f 00 00       	mov    %eax,0xf00
}
 6ae:	5b                   	pop    %ebx
 6af:	5e                   	pop    %esi
 6b0:	5f                   	pop    %edi
 ...
 6cf:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6d2:	a3 00 0f 00 00       	mov    %eax,0xf00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 1d 00 0f 00 00    	mov    0xf00,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 73b:	3b 15 00 0f 00 00    	cmp    0xf00,%edx
 ...
 76d:	e8 ee fe ff ff       	call   660 <free>
  return freep;
 772:	8b 15 00 0f 00 00    	mov    0xf00,%edx
 ...
 794:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 797:	89 15 00 0f 00 00    	mov    %edx,0xf00
      return (void*)(p + 1);
 ...
 7ac:	eb e9                	jmp    797 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7ae:	c7 05 00 0f 00 00 04 	movl   $0xf04,0xf00
 7b5:	0f 00 00 
    base.s.size = 0;
 7b8:	ba 04 0f 00 00       	mov    $0xf04,%edx
    base.s.ptr = freep = prevp = &base;
 7bd:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 7c4:	0f 00 00 
    base.s.size = 0;
 7c7:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 7ce:	00 00 00 

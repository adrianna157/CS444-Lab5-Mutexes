...
#endif // KTHREADS
#ifdef BENNY_MOOTEX
extern int sys_kthread_self(void);
extern int sys_kthread_yield(void);
extern int sys_kthread_cpu_count(void);
extern int sys_kthread_thread_count(void);
#endif //BENNY_MOOTEX
...
#ifdef BENNY_MOOTEX
  [SYS_kthread_self] sys_kthread_self,
  [SYS_kthread_yield] sys_kthread_yield,
  [SYS_kthread_cpu_count] sys_kthread_cpu_count,
  [SYS_kthread_thread_count] sys_kthread_thread_count,
#endif //BENNY MOOTEX
};

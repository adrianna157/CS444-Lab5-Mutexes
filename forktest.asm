  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fork test\n");
  49:	c7 44 24 04 44 04 00 	movl   $0x444,0x4(%esp)
  50:	00 
  ...
  printf(1, "fork test OK\n");
  a2:	c7 44 24 04 76 04 00 	movl   $0x476,0x4(%esp)
  a9:	00 
  ...
  write(fd, s, strlen(s));
  c0:	c7 04 24 84 04 00 00 	movl   $0x484,(%esp)
  c7:	e8 d4 00 00 00       	call   1a0 <strlen>
  cc:	c7 44 24 04 84 04 00 	movl   $0x484,0x4(%esp)
  d3:	00 
  ...
  e9:	c7 44 24 04 4f 04 00 	movl   $0x44f,0x4(%esp)
  f0:	00 
 ...
 102:	c7 44 24 04 63 04 00 	movl   $0x463,0x4(%esp)
 109:	00 

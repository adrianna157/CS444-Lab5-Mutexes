...
main(int argc, char *argv[])
{
  ...
  18:	75 32                	jne    4c <main+0x4c>
        int cppid = getppid();
  1a:	e8 23 03 00 00       	call   342 <getppid>
        assert(ppid == cppid);
  1f:	39 c3                	cmp    %eax,%ebx
  21:	74 33                	je     56 <main+0x56>
  23:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%esp)
  2a:	00 
  2b:	c7 44 24 08 5c 0a 00 	movl   $0xa5c,0x8(%esp)
  32:	00 
  33:	c7 44 24 04 80 0a 00 	movl   $0xa80,0x4(%esp)
  3a:	00 
  ...
  47:	e8 56 02 00 00       	call   2a2 <exit>
    ...
    wait();
  4c:	e8 59 02 00 00       	call   2aa <wait>
#endif // GETPPID
    exit();
  51:	e8 4c 02 00 00       	call   2a2 <exit>
        printf(1, "test success: %d %d\n", ppid, cppid);
  56:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
  5a:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  5e:	c7 44 24 04 6a 0a 00 	movl   $0xa6a,0x4(%esp)
  65:	00 
  66:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6d:	e8 de 03 00 00       	call   450 <printf>
        exit();
  72:	e8 2b 02 00 00       	call   2a2 <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e9:	0f b6 92 ab 0a 00 00 	movzbl 0xaab(%edx),%edx
  }while((x /= base) != 0);
 ...
 45e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5d1:	b8 a4 0a 00 00       	mov    $0xaa4,%eax
...
free(void *ap)
{
 ...
 671:	a1 30 0f 00 00       	mov    0xf30,%eax
{
 ...
 6b7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6b9:	a3 30 0f 00 00       	mov    %eax,0xf30
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6df:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6e2:	a3 30 0f 00 00       	mov    %eax,0xf30
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 1d 30 0f 00 00    	mov    0xf30,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 74b:	3b 15 30 0f 00 00    	cmp    0xf30,%edx
 ...
 77d:	e8 ee fe ff ff       	call   670 <free>
  return freep;
 782:	8b 15 30 0f 00 00    	mov    0xf30,%edx
 ...
 7a4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 30 0f 00 00    	mov    %edx,0xf30
      return (void*)(p + 1);
 ...
 7bc:	eb e9                	jmp    7a7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7be:	c7 05 30 0f 00 00 34 	movl   $0xf34,0xf30
 7c5:	0f 00 00 
    base.s.size = 0;
 7c8:	ba 34 0f 00 00       	mov    $0xf34,%edx
    base.s.ptr = freep = prevp = &base;
 7cd:	c7 05 34 0f 00 00 34 	movl   $0xf34,0xf34
 7d4:	0f 00 00 
    base.s.size = 0;
 7d7:	c7 05 38 0f 00 00 00 	movl   $0x0,0xf38
 7de:	00 00 00 

...
main(int argc, char **argv)
{
   ...
   b:	e8 b0 0b 00 00       	call   bc0 <benny_cpu_count>

    if (ncpus < 2) {
  10:	83 f8 01             	cmp    $0x1,%eax
  13:	0f 8e 38 01 00 00    	jle    151 <main+0x151>
        printf(1, "this is more interesting with more than 1 cpu\n");
    }
    global = 0;
    benny_thread_create(&bt, func1, (void *) NULL);
  19:	8d 74 24 1c          	lea    0x1c(%esp),%esi
    sleep(1);
  1d:	bb a0 86 01 00       	mov    $0x186a0,%ebx
    benny_thread_create(&bt, func1, (void *) NULL);
  22:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  29:	00 
  2a:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  31:	00 
  32:	89 34 24             	mov    %esi,(%esp)
    global = 0;
  35:	c7 05 60 11 00 00 00 	movl   $0x0,0x1160
  3c:	00 00 00 
    benny_thread_create(&bt, func1, (void *) NULL);
  3f:	e8 2c 09 00 00       	call   970 <benny_thread_create>
    sleep(1);
  44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  4b:	e8 62 04 00 00       	call   4b2 <sleep>
    for (i = 0; i < ITERATIONS; i++) {
        benny_mootex_spinlock(&mootex);
  50:	c7 04 24 58 11 00 00 	movl   $0x1158,(%esp)
  57:	e8 84 0a 00 00       	call   ae0 <benny_mootex_spinlock>
        global++;
        benny_mootex_unlock(&mootex);
  5c:	c7 04 24 58 11 00 00 	movl   $0x1158,(%esp)
        global++;
  63:	83 05 60 11 00 00 01 	addl   $0x1,0x1160
        benny_mootex_unlock(&mootex);
  6a:	e8 a1 0a 00 00       	call   b10 <benny_mootex_unlock>
    for (i = 0; i < ITERATIONS; i++) {
  6f:	83 eb 01             	sub    $0x1,%ebx
  72:	75 dc                	jne    50 <main+0x50>
    }
    benny_thread_join(bt);
  74:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  78:	89 04 24             	mov    %eax,(%esp)
  7b:	e8 a0 09 00 00       	call   a20 <benny_thread_join>
    printf(1, "\tglobal value with spin locks: %d\n", global);
  80:	a1 60 11 00 00       	mov    0x1160,%eax
  85:	c7 44 24 04 34 0c 00 	movl   $0xc34,0x4(%esp)
  8c:	00 
  8d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  94:	89 44 24 08          	mov    %eax,0x8(%esp)
  98:	e8 33 05 00 00       	call   5d0 <printf>
    assert(global == (ITERATIONS * 2));
  9d:	81 3d 60 11 00 00 40 	cmpl   $0x30d40,0x1160
  a4:	0d 03 00 
  a7:	74 29                	je     d2 <main+0xd2>
  a9:	c7 44 24 0c 38 00 00 	movl   $0x38,0xc(%esp)
  b0:	00 
    ...
    benny_thread_join(bt);
    assert(global == (ITERATIONS * 2));
  b1:	c7 44 24 08 fa 0b 00 	movl   $0xbfa,0x8(%esp)
  b8:	00 
  b9:	c7 44 24 04 58 0c 00 	movl   $0xc58,0x4(%esp)
  c0:	00 
  c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  c8:	e8 03 05 00 00       	call   5d0 <printf>
  cd:	e8 50 03 00 00       	call   422 <exit>
    benny_thread_create(&bt, func1, (void *) NULL);
  d2:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
  d9:	00 
    sleep(1);
  da:	bb a0 86 01 00       	mov    $0x186a0,%ebx
    benny_thread_create(&bt, func1, (void *) NULL);
  df:	c7 44 24 04 90 01 00 	movl   $0x190,0x4(%esp)
  e6:	00 
  e7:	89 34 24             	mov    %esi,(%esp)
    global = 0;
  ea:	c7 05 60 11 00 00 00 	movl   $0x0,0x1160
  f1:	00 00 00 
    benny_thread_create(&bt, func1, (void *) NULL);
  f4:	e8 77 08 00 00       	call   970 <benny_thread_create>
    sleep(1);
  f9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 100:	e8 ad 03 00 00       	call   4b2 <sleep>
 105:	8d 76 00             	lea    0x0(%esi),%esi
        benny_mootex_yieldlock(&mootex);
 108:	c7 04 24 58 11 00 00 	movl   $0x1158,(%esp)
 10f:	e8 8c 09 00 00       	call   aa0 <benny_mootex_yieldlock>
        benny_mootex_unlock(&mootex);
 114:	c7 04 24 58 11 00 00 	movl   $0x1158,(%esp)
        global++;
 11b:	83 05 60 11 00 00 01 	addl   $0x1,0x1160
        benny_mootex_unlock(&mootex);
 122:	e8 e9 09 00 00       	call   b10 <benny_mootex_unlock>
    for (i = 0; i < ITERATIONS; i++) {
 127:	83 eb 01             	sub    $0x1,%ebx
 12a:	75 dc                	jne    108 <main+0x108>
    benny_thread_join(bt);
 12c:	8b 44 24 1c          	mov    0x1c(%esp),%eax
 130:	89 04 24             	mov    %eax,(%esp)
 133:	e8 e8 08 00 00       	call   a20 <benny_thread_join>
    assert(global == (ITERATIONS * 2));
 138:	81 3d 60 11 00 00 40 	cmpl   $0x30d40,0x1160
 13f:	0d 03 00 
 142:	74 26                	je     16a <main+0x16a>
 144:	c7 44 24 0c 43 00 00 	movl   $0x43,0xc(%esp)
 14b:	00 
 14c:	e9 60 ff ff ff       	jmp    b1 <main+0xb1>
        printf(1, "this is more interesting with more than 1 cpu\n");
 151:	c7 44 24 04 04 0c 00 	movl   $0xc04,0x4(%esp)
 158:	00 
 159:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 160:	e8 6b 04 00 00       	call   5d0 <printf>
 165:	e9 af fe ff ff       	jmp    19 <main+0x19>

    printf(1, "\tglobal value with mixed locks   : %d\n", global);
 16a:	c7 44 24 08 40 0d 03 	movl   $0x30d40,0x8(%esp)
 171:	00 
 172:	c7 44 24 04 7c 0c 00 	movl   $0xc7c,0x4(%esp)
 179:	00 
 17a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 181:	e8 4a 04 00 00       	call   5d0 <printf>

#endif // BENNY_MOOTEX
    exit();
 186:	e8 97 02 00 00       	call   422 <exit>
...
00000190 <func1>:
{
 ...
 194:	bb a0 86 01 00       	mov    $0x186a0,%ebx
{
 199:	83 ec 14             	sub    $0x14,%esp
    printf(1, "thread starting\n");
 19c:	c7 44 24 04 dc 0b 00 	movl   $0xbdc,0x4(%esp)
 1a3:	00 
 1a4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1ab:	e8 20 04 00 00       	call   5d0 <printf>
        benny_mootex_spinlock(&mootex);
 1b0:	c7 04 24 58 11 00 00 	movl   $0x1158,(%esp)
 1b7:	e8 24 09 00 00       	call   ae0 <benny_mootex_spinlock>
        benny_mootex_unlock(&mootex);
 1bc:	c7 04 24 58 11 00 00 	movl   $0x1158,(%esp)
        global++;
 1c3:	83 05 60 11 00 00 01 	addl   $0x1,0x1160
        benny_mootex_unlock(&mootex);
 1ca:	e8 41 09 00 00       	call   b10 <benny_mootex_unlock>
    for (i = 0; i < ITERATIONS; i++) {
 1cf:	83 eb 01             	sub    $0x1,%ebx
 1d2:	75 dc                	jne    1b0 <func1+0x20>
    printf(1, "thread done\n");
 1d4:	c7 44 24 04 ed 0b 00 	movl   $0xbed,0x4(%esp)
 1db:	00 
 1dc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 1e3:	e8 e8 03 00 00       	call   5d0 <printf>
    benny_thread_exit(0);
 1e8:	c7 45 08 00 00 00 00 	movl   $0x0,0x8(%ebp)
}
 1ef:	83 c4 14             	add    $0x14,%esp
 1f2:	5b                   	pop    %ebx
 1f3:	5d                   	pop    %ebp
    benny_thread_exit(0);
 1f4:	e9 77 08 00 00       	jmp    a70 <benny_thread_exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 569:	0f b6 92 ab 0c 00 00 	movzbl 0xcab(%edx),%edx
  }while((x /= base) != 0);
 ...
 5de:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 74f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 751:	b8 a4 0c 00 00       	mov    $0xca4,%eax
...
free(void *ap)
{
 ...
 7f1:	a1 64 11 00 00       	mov    0x1164,%eax
{
 ...
 837:	89 10                	mov    %edx,(%eax)
  freep = p;
 839:	a3 64 11 00 00       	mov    %eax,0x1164
}
 83e:	5b                   	pop    %ebx
 83f:	5e                   	pop    %esi
 840:	5f                   	pop    %edi
 ...
 85f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 862:	a3 64 11 00 00       	mov    %eax,0x1164
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 889:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 88c:	8b 1d 64 11 00 00    	mov    0x1164,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 8cb:	3b 15 64 11 00 00    	cmp    0x1164,%edx
 ...
 8fd:	e8 ee fe ff ff       	call   7f0 <free>
  return freep;
 902:	8b 15 64 11 00 00    	mov    0x1164,%edx
 ...
 924:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 927:	89 15 64 11 00 00    	mov    %edx,0x1164
      return (void*)(p + 1);
 ...
 93c:	eb e9                	jmp    927 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 93e:	c7 05 64 11 00 00 68 	movl   $0x1168,0x1164
 945:	11 00 00 
    base.s.size = 0;
 948:	ba 68 11 00 00       	mov    $0x1168,%edx
    base.s.ptr = freep = prevp = &base;
 94d:	c7 05 68 11 00 00 68 	movl   $0x1168,0x1168
 954:	11 00 00 
    base.s.size = 0;
 957:	c7 05 6c 11 00 00 00 	movl   $0x0,0x116c
 95e:	00 00 00 

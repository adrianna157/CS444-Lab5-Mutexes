   ...
   5:	be 01 00 00 00       	mov    $0x1,%esi
{
  ...
  3f:	c7 44 24 04 70 0a 00 	movl   $0xa70,0x4(%esp)
  46:	00 
  ...
  57:	eb df                	jmp    38 <main+0x38>
    printf(2, "Usage: mkdir files...\n");
  59:	c7 44 24 04 59 0a 00 	movl   $0xa59,0x4(%esp)
  60:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e9:	0f b6 92 93 0a 00 00 	movzbl 0xa93(%edx),%edx
  }while((x /= base) != 0);
 ...
 45e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5d1:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
...
free(void *ap)
{
 ...
 671:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 6b7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6b9:	a3 20 0f 00 00       	mov    %eax,0xf20
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6df:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6e2:	a3 20 0f 00 00       	mov    %eax,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 1d 20 0f 00 00    	mov    0xf20,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 74b:	3b 15 20 0f 00 00    	cmp    0xf20,%edx
 ...
 77d:	e8 ee fe ff ff       	call   670 <free>
  return freep;
 782:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 7a4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 20 0f 00 00    	mov    %edx,0xf20
      return (void*)(p + 1);
 ...
 7bc:	eb e9                	jmp    7a7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7be:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 7c5:	0f 00 00 
    base.s.size = 0;
 7c8:	ba 24 0f 00 00       	mov    $0xf24,%edx
    base.s.ptr = freep = prevp = &base;
 7cd:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 7d4:	0f 00 00 
    base.s.size = 0;
 7d7:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 7de:	00 00 00 

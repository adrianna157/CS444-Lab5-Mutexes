...
main(int argc, char **argv)
{
   ...
   9:	83 ec 70             	sub    $0x70,%esp
    ...
    pid = fork();
   c:	e8 f9 03 00 00       	call   40a <fork>
    if (pid == 0) {
  11:	85 c0                	test   %eax,%eax
  13:	0f 85 2a 01 00 00    	jne    143 <main+0x143>
        //printf(1, "%s %d: %p %p\n", __FILE__, __LINE__, main, &argc);
        if (argc > 1) {
  19:	83 7d 08 01          	cmpl   $0x1,0x8(%ebp)
  1d:	7e 18                	jle    37 <main+0x37>
            num_threads = atoi(argv[1]);
  1f:	8b 45 0c             	mov    0xc(%ebp),%eax
  22:	8b 40 04             	mov    0x4(%eax),%eax
  25:	89 04 24             	mov    %eax,(%esp)
  28:	e8 83 03 00 00       	call   3b0 <atoi>
  2d:	89 c6                	mov    %eax,%esi
            if (num_threads < 1 || num_threads > MAX_THREADS) {
  2f:	8d 40 ff             	lea    -0x1(%eax),%eax
  32:	83 f8 13             	cmp    $0x13,%eax
  35:	76 05                	jbe    3c <main+0x3c>
    long num_threads = DEFAULT_NUM_THREADS;
  ...
  40:	8d 7c 24 20          	lea    0x20(%esp),%edi
    
        for (i = 0; i < num_threads; i++) {
  44:	31 db                	xor    %ebx,%ebx
        printf(1, "Starting %d threads\n", num_threads);
  46:	c7 44 24 04 df 0b 00 	movl   $0xbdf,0x4(%esp)
  4d:	00 
  4e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  55:	e8 66 05 00 00       	call   5c0 <printf>
  ...
  6d:	c7 44 24 04 50 01 00 	movl   $0x150,0x4(%esp)
  74:	00 
  75:	e8 e6 08 00 00       	call   960 <benny_thread_create>
            printf(1, "%s %d: %d\n", __FILE__, __LINE__, benny_thread_bid(bt[i]));
  7a:	8b 47 fc             	mov    -0x4(%edi),%eax
  7d:	89 04 24             	mov    %eax,(%esp)
  80:	e8 7b 09 00 00       	call   a00 <benny_thread_bid>
  85:	c7 44 24 0c 41 00 00 	movl   $0x41,0xc(%esp)
  8c:	00 
  8d:	c7 44 24 08 f4 0b 00 	movl   $0xbf4,0x8(%esp)
  94:	00 
  95:	c7 44 24 04 fd 0b 00 	movl   $0xbfd,0x4(%esp)
  9c:	00 
  9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  a4:	89 44 24 10          	mov    %eax,0x10(%esp)
  a8:	e8 13 05 00 00       	call   5c0 <printf>
        for (i = 0; i < num_threads; i++) {
  ad:	39 de                	cmp    %ebx,%esi
  af:	7f af                	jg     60 <main+0x60>

        // my code does not allow you to join with thread 0
        //rez = kthread_join(0);
        //printf(1, "%s %d: %d\n", __FILE__, __LINE__, rez);
        rez = -17;
        rez = kthread_join(50);
  b1:	c7 04 24 32 00 00 00 	movl   $0x32,(%esp)
        printf(1, "%s %d: %d\n", __FILE__, __LINE__, rez);
        
        for (i = 0; i < num_threads; i++) {
  b8:	31 db                	xor    %ebx,%ebx
        rez = kthread_join(50);
  ba:	e8 23 04 00 00       	call   4e2 <kthread_join>
        printf(1, "%s %d: %d\n", __FILE__, __LINE__, rez);
  bf:	c7 44 24 0c 49 00 00 	movl   $0x49,0xc(%esp)
  c6:	00 
  c7:	c7 44 24 08 f4 0b 00 	movl   $0xbf4,0x8(%esp)
  ce:	00 
  cf:	c7 44 24 04 fd 0b 00 	movl   $0xbfd,0x4(%esp)
  d6:	00 
  d7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  de:	89 44 24 10          	mov    %eax,0x10(%esp)
  e2:	e8 d9 04 00 00       	call   5c0 <printf>
  e7:	90                   	nop
            printf(1, "%s %d: joining with %d\n"
  e8:	8b 44 9c 20          	mov    0x20(%esp,%ebx,4),%eax
  ec:	89 04 24             	mov    %eax,(%esp)
  ef:	e8 0c 09 00 00       	call   a00 <benny_thread_bid>
  f4:	c7 44 24 0c 4d 00 00 	movl   $0x4d,0xc(%esp)
  fb:	00 
  fc:	c7 44 24 08 f4 0b 00 	movl   $0xbf4,0x8(%esp)
 103:	00 
 104:	c7 44 24 04 08 0c 00 	movl   $0xc08,0x4(%esp)
 10b:	00 
 10c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 113:	89 44 24 10          	mov    %eax,0x10(%esp)
 117:	e8 a4 04 00 00       	call   5c0 <printf>
                   , __FILE__, __LINE__, benny_thread_bid(bt[i]));
            benny_thread_join(bt[i]);
 11c:	8b 44 9c 20          	mov    0x20(%esp,%ebx,4),%eax
        for (i = 0; i < num_threads; i++) {
 120:	83 c3 01             	add    $0x1,%ebx
            benny_thread_join(bt[i]);
 123:	89 04 24             	mov    %eax,(%esp)
 126:	e8 e5 08 00 00       	call   a10 <benny_thread_join>
        for (i = 0; i < num_threads; i++) {
 12b:	39 de                	cmp    %ebx,%esi
 12d:	7f b9                	jg     e8 <main+0xe8>
        }

        printf(1, "All threads joined\n");
 12f:	c7 44 24 04 20 0c 00 	movl   $0xc20,0x4(%esp)
 136:	00 
...
#endif // KTHREADS
    exit();
 143:	e8 ca 02 00 00       	call   412 <exit>
 ...
 162:	bb 02 00 00 00       	mov    $0x2,%ebx
{
 ...
 1a1:	c7 44 24 04 c9 0b 00 	movl   $0xbc9,0x4(%esp)
 1a8:	00 
 ...
 1bb:	e8 00 04 00 00       	call   5c0 <printf>
            sum = 0;
 ...
 1de:	5d                   	pop    %ebp
    benny_thread_exit(7);
 1df:	e9 7c 08 00 00       	jmp    a60 <benny_thread_exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 559:	0f b6 92 3b 0c 00 00 	movzbl 0xc3b(%edx),%edx
  }while((x /= base) != 0);
 ...
 5ce:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 73f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 741:	b8 34 0c 00 00       	mov    $0xc34,%eax
...
free(void *ap)
{
 ...
 7e1:	a1 f4 10 00 00       	mov    0x10f4,%eax
{
 ...
 827:	89 10                	mov    %edx,(%eax)
  freep = p;
 829:	a3 f4 10 00 00       	mov    %eax,0x10f4
}
 82e:	5b                   	pop    %ebx
 82f:	5e                   	pop    %esi
 830:	5f                   	pop    %edi
 ...
 84f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 852:	a3 f4 10 00 00       	mov    %eax,0x10f4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 879:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 87c:	8b 1d f4 10 00 00    	mov    0x10f4,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8b9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 8bb:	3b 15 f4 10 00 00    	cmp    0x10f4,%edx
 ...
 8ed:	e8 ee fe ff ff       	call   7e0 <free>
  return freep;
 8f2:	8b 15 f4 10 00 00    	mov    0x10f4,%edx
 ...
 914:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 917:	89 15 f4 10 00 00    	mov    %edx,0x10f4
      return (void*)(p + 1);
 ...
 92c:	eb e9                	jmp    917 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 92e:	c7 05 f4 10 00 00 f8 	movl   $0x10f8,0x10f4
 935:	10 00 00 
    base.s.size = 0;
 938:	ba f8 10 00 00       	mov    $0x10f8,%edx
    base.s.ptr = freep = prevp = &base;
 93d:	c7 05 f8 10 00 00 f8 	movl   $0x10f8,0x10f8
 944:	10 00 00 
    base.s.size = 0;
 947:	c7 05 fc 10 00 00 00 	movl   $0x0,0x10fc
 94e:	00 00 00 

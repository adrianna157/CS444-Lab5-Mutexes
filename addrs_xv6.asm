...
printint(int fd, int xx, int base, int sgn)
{
 ...
 539:	0f b6 92 4e 0d 00 00 	movzbl 0xd4e(%edx),%edx
  }while((x /= base) != 0);
 ...
 5ae:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 71f:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 721:	b8 47 0d 00 00       	mov    $0xd47,%eax
...
free(void *ap)
{
 ...
 7c1:	a1 e4 11 00 00       	mov    0x11e4,%eax
{
 ...
 807:	89 10                	mov    %edx,(%eax)
  freep = p;
 809:	a3 e4 11 00 00       	mov    %eax,0x11e4
}
 80e:	5b                   	pop    %ebx
 80f:	5e                   	pop    %esi
 810:	5f                   	pop    %edi
 ...
 82f:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 832:	a3 e4 11 00 00       	mov    %eax,0x11e4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 859:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 85c:	8b 1d e4 11 00 00    	mov    0x11e4,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 899:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 89b:	3b 15 e4 11 00 00    	cmp    0x11e4,%edx
 ...
 8cd:	e8 ee fe ff ff       	call   7c0 <free>
  return freep;
 8d2:	8b 15 e4 11 00 00    	mov    0x11e4,%edx
 ...
 8f4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8f7:	89 15 e4 11 00 00    	mov    %edx,0x11e4
      return (void*)(p + 1);
 ...
 90c:	eb e9                	jmp    8f7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 90e:	c7 05 e4 11 00 00 e8 	movl   $0x11e8,0x11e4
 915:	11 00 00 
    base.s.size = 0;
 918:	ba e8 11 00 00       	mov    $0x11e8,%edx
    base.s.ptr = freep = prevp = &base;
 91d:	c7 05 e8 11 00 00 e8 	movl   $0x11e8,0x11e8
 924:	11 00 00 
    base.s.size = 0;
 927:	c7 05 ec 11 00 00 00 	movl   $0x0,0x11ec
 92e:	00 00 00 

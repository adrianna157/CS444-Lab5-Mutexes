...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c 59 0a 00 	movl   $0xa59,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 5b 0a 00 	movl   $0xa5b,0x4(%esp)
  33:	00 
  ...
  4b:	c7 44 24 0c 60 0a 00 	movl   $0xa60,0xc(%esp)
  52:	00 
  53:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  57:	c7 44 24 04 5b 0a 00 	movl   $0xa5b,0x4(%esp)
  5e:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e9:	0f b6 92 69 0a 00 00 	movzbl 0xa69(%edx),%edx
  }while((x /= base) != 0);
 ...
 45e:	8d 45 10             	lea    0x10(%ebp),%eax
{
 ...
 5cf:	8b 38                	mov    (%eax),%edi
          s = "(null)";
 5d1:	b8 62 0a 00 00       	mov    $0xa62,%eax
...
free(void *ap)
{
 ...
 671:	a1 f4 0e 00 00       	mov    0xef4,%eax
{
 ...
 6b7:	89 10                	mov    %edx,(%eax)
  freep = p;
 6b9:	a3 f4 0e 00 00       	mov    %eax,0xef4
}
 6be:	5b                   	pop    %ebx
 6bf:	5e                   	pop    %esi
 6c0:	5f                   	pop    %edi
 ...
 6df:	03 4b fc             	add    -0x4(%ebx),%ecx
  freep = p;
 6e2:	a3 f4 0e 00 00       	mov    %eax,0xef4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 1d f4 0e 00 00    	mov    0xef4,%ebx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 74b:	3b 15 f4 0e 00 00    	cmp    0xef4,%edx
 ...
 77d:	e8 ee fe ff ff       	call   670 <free>
  return freep;
 782:	8b 15 f4 0e 00 00    	mov    0xef4,%edx
 ...
 7a4:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7a7:	89 15 f4 0e 00 00    	mov    %edx,0xef4
      return (void*)(p + 1);
 ...
 7bc:	eb e9                	jmp    7a7 <malloc+0xa7>
    base.s.ptr = freep = prevp = &base;
 7be:	c7 05 f4 0e 00 00 f8 	movl   $0xef8,0xef4
 7c5:	0e 00 00 
    base.s.size = 0;
 7c8:	ba f8 0e 00 00       	mov    $0xef8,%edx
    base.s.ptr = freep = prevp = &base;
 7cd:	c7 05 f8 0e 00 00 f8 	movl   $0xef8,0xef8
 7d4:	0e 00 00 
    base.s.size = 0;
 7d7:	c7 05 fc 0e 00 00 00 	movl   $0x0,0xefc
 7de:	00 00 00 
